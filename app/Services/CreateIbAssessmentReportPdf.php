...
class CreateIbAssessmentReportPdf
{
    ...
    public function generateIbAssessmentReportPdf()
    {
    ...
    {
        $ibReportInfo = IbReportInfo::find($this->ibReportInfoId);
        ...
        // dd($signer)     ;       
        $body = view('certify.ib.save_assessment_ib.report-pdf.ia.body', [
        ...
        $footer = view('certify.ib.save_assessment_ib.report-pdf.ia.footer', []);
        $header = view('certify.ib.save_assessment_ib.report-pdf.ia.header', [
            'certi_ib' => $certi_ib
        ]);
