...
class MeetingAppointmentCommitteePdf
{
    ...
    public function generateMeetingAppointmentCommitteePdf()
    {
        $meetingInvitation = MeetingInvitation::find($this->meetingInvitationId);
        ...
        $docQr = AttachFile::where('ref_table', 'meeting_invitations')
        ...
        $ggFormQr = AttachFile::where('ref_table', 'meeting_invitations')
        ->where('ref_id', $meetingInvitation->id)
        ->where('section', 789)
        ->first();
