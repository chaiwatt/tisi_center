...
class NoticeItem extends Model
{
    ...
    protected $fillable = ['app_certi_lab_notice_id','remark','report','no','type','status','reporter','reporter_id','attachs','comment','comment_file','file_status','details','attachs_client_name','owner_id','cause','user_cause'];
