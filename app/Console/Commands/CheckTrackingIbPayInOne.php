...
class CheckTrackingIbPayInOne extends Command
{
    ...
    protected $signature = 'check:tracking-ib-payin-one';
    protected $description = 'ตรวจสอบการชำระเงินระบบ epayment ของการติดตาม payin1 ib';
    ...
    public function updateTrackingIbPayin1()
    {
                    ...
                    if (is_array($response) && count($response) > 0) {
                        ...
                        if ($url != null) {
                            ...
                            if (HP::checkFileStorage($url)) {
                                ...
                                $filePath = 'files/trackingib/' . $referenceRefno;
        ...
        $this->info("ตรวจสอบการชำระเงินระบบ epayment ของการตรวจติดตาม payin1 ib เสร็จสิ้น");
    }
}
