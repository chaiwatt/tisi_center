...
class CheckTrackingCbPayInOne extends Command
{
    ...
    protected $signature = 'check:tracking-cb-payin-one';
    protected $description = 'ตรวจสอบการชำระเงินระบบ epayment ของการติดตาม payin1 cb';
    ...
    {
        $this->updateTrackingCbPayin1();
    }

    public function updateTrackingCbPayin1()
    {
                    ...
                    if (is_array($response) && count($response) > 0) {
                        ...
                        if ($url != null) {
                            ...
                            if (HP::checkFileStorage($url)) {
                                ...
                                $filePath = 'files/trackingcb/' . $referenceRefno;
        ...
        $this->info("ตรวจสอบการชำระเงินระบบ epayment ของการตรวจติดตาม payin1 cb เสร็จสิ้น");
    }
}
