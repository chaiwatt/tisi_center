...
class GenerateIbFinalReportProcessOnePdf implements ShouldQueue
{
    ...
    public function __construct(
        ...
        string $no,
        int $certi_ib_id,
        ?int $assessment_app_certi_ib_id,
    ...
    {
        Log::info('--- GenerateIbCbFinalReportProcessOnePdf STARTED. ---', ['file' => $this->fullFileName]);
        ...
        try {
            ...
            Log::error('Exception in GenerateIbCbFinalReportProcessOnePdf: ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);
            $this->fail($e);
        } finally {
