...
class GenerateCbCarReportProcessOnePdf implements ShouldQueue
{
            ...
            if ($process->isSuccessful() && Storage::disk($diskName)->exists($this->fullFileName)) {
                ...
                if (Storage::disk('ftp')->exists($this->attachPath . $this->fullFileName)) {
                    ...
                    if ($certiCBSaveAssessment) {
                        ...
                        Log::info("Cb car report ".'http://127.0.0.1:8081/certify/check/file_cb_client/'.$storePath.'/'. $this->fullFileName);
