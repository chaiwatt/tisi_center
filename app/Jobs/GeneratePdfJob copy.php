...
class GeneratePdfJob implements ShouldQueue
{
    ...
    public function handle()
    {
            ...
            try {
                ...
                // 5. สร้าง Command String ที่สมบูรณ์เพื่อเรียก generate-pdf.js
                $command = 'HOME=/tmp ' .
                ...
                $process->setTimeout(120); // เพิ่ม timeout สำหรับงานสร้าง PDF
                $process->run();
                ...
                // 8. ลบไฟล์ HTML ชั่วคราวทิ้งไปเสมอ ไม่ว่าจะสำเร็จหรือล้มเหลว
