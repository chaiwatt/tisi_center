...
<body>
    ...
    <script>
        ...
        // **NEW**: รับค่า status จาก Controller
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function lockEditor() {
                ...
                // ล็อกคอนเทนเนอร์หลักเพื่อป้องกัน event bubbling ที่อาจทำให้แก้ไขได้
                ...
                // ซ่อนปุ่มบน Toolbar ที่ไม่ต้องการให้ใช้งาน
            ...
            loadTemplateBtn.addEventListener('click', () => {
                ...
                .then(data => {
                    ...
                    // **NEW**: ตรวจสอบ status และล็อก editor ถ้าจำเป็น
            ...
            // **NEW**: ตรวจสอบ initialStatus ตอนโหลดหน้าครั้งแรก
            ...
            function saveData(status) {
                ...
                .then(data => {
                    ...
                    // **NEW**: ถ้าบันทึกเป็น final ให้ล็อก editor ทันที
                    if (status === 'final') {
                        lockEditor();
                    }
                })
                ...
                .finally(() => {
                    loadingIndicator.style.display = 'none';
                    // ไม่ต้องเปิดปุ่มถ้าถูกล็อกไปแล้ว
                    if (status !== 'final') {
