...
<div class="row">
     <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('cb_name') ? 'has-error' : '' }}">
            ...
            <div class="col-md-7">
                <input type="text" id="cb_name" name="cb_name" class="form-control no-drop" value="{{ $certiCb->EsurvTrader->name ?? '' }}" readonly>
            </div>
        </div>
        ...
        <div class="form-group {{ $errors->has('name_standard') ? 'has-error' : '' }}">
            ...
            <div class="col-md-7">
                <input type="text" id="name_standard" name="name_standard" class="form-control" value="{{ $certiCb->name_standard ?? '' }}" disabled>
            </div>
        </div>
        ...
        <div class="form-group {{ $errors->has('auditor') ? 'has-error' : '' }}">
            ...
            <div class="col-md-7">
                <input type="text" id="auditor" name="auditor" class="form-control" maxlength="255" value="{{ 'คณะผู้ตรวจหน่วยรับรอง '.$certiCb->name_standard ?? '' }}" required>
            </div>
        </div>
