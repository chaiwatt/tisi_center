    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '{!! url('/certify/auditor-assignment/data-list') !!}',
                    data: function (d) {
        ...
        //     $.ajax({
        //         url: "{{ route('auditor_assignment.get_signer') }}", // URL ของ route
        //         type: 'GET',
        ...
        $(document).on('click', '#signDocument', function() {
            ...
            $.ajax({
                url: "{{ route('auditor_assignment.signDocument') }}",
                type: 'POST',
                data: { 
