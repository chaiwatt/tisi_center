          ...
          <ul class="nav nav-tabs process-model more-icon-preocess" role="tablist">
            <li role="presentation">
               <a id="1" href="#plan_standards" aria-controls="plan_standards" role="tab" data-toggle="tab" 
                @if(isset($setstandard) && $setstandard->status_sub_appointment_id == 0) class="active"@endif
                >
                     <span>1</span>
                     <p>รายละเอียดการกำหนดมาตรฐาน(อนุ)</p>
                 </a>
            </li>
            <li role="presentation" >
                <a id="2" href="#plan_time"  aria-controls="plan_time"   role="tab" data-toggle="tab" 
                 @if(isset($setstandard) && $setstandard->status_sub_appointment_id == 1) class="active"@endif
                >
                    <span>2</span>
                    <p>แผนการกำหนดมาตรฐาน(อนุ)</p>
              </a>
            </li>
            <li role="presentation">
                <a  id="3" href="#meet_topic" aria-controls="meet_topic" role="tab" data-toggle="tab" 
                @if(isset($setstandard) &&  in_array($setstandard->status_sub_appointment_id,[2,3])) class="active"@endif
                >
                    <span>3</span>
                    <p>วาระการประชุม(อนุ)</p>
                </a>
            </li>   
            <li role="presentation">
                <a  id="4" href="#summarize" aria-controls="summarize" role="tab" data-toggle="tab" 
                @if(isset($setstandard) && in_array($setstandard->status_sub_appointment_id,[4,5])) class="active"@endif
                >
                    <span>4</span>
                    <p>สรุปวาระการประชุม(อนุ)</p>
                </a>
            </li>
          </ul>
...
<div class="col-md-12" id="boxs_readonly"   >
        ...
        <div class="white-box">
            <div class="row">
                <div class="col-md-12">
                   ...
                   @include ('certify.set-standards.form-plan-standards_sub_appointment')
              </div>
         </div>
        </div>
    </div>
    ...
    <div role="tabpanel" class="tab-pane" id="meet_topic">
        <div class="white-box">
            <div class="row">
                <div class="col-md-12">
                    @include ('certify.set-standards.form-meet-topic_sub_appointment')
              </div>
         </div>
        </div>
    </div>
    ...
    <div role="tabpanel" class="tab-pane" id="summarize">
        <div class="white-box">
            <div class="row">
                <div class="col-md-12">
                    @include ('certify.set-standards.form-report-meet_sub_appointment')
              </div>
         </div>
        </div>
    </div>
...
@if (!empty($setstandard->condition) && $setstandard->condition == 'form_edit')
        ...
        @elseif (in_array($setstandard->status_sub_appointment_id,[5]))
    ...
    $(document).ready(function () {
       ...
       @endif
          ...
          // อนุญาติให้กรอกได้เฉพาะตัวเลข 0-9 จุด และคอมม่า
           ...
           var status =    "{{!empty($setstandard->status_sub_appointment_id) ? $setstandard->status_sub_appointment_id : 0 }}";
