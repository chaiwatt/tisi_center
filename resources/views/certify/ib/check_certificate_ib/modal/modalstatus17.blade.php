...
@endpush
  ...
  <div class="modal fade  " id="exampleModalReport" tabindex="-1" role="dialog" aria-labelledby="exampleModalReportLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title" id="exampleModalReportLabel">สรุปรายงานและเสนอกรรมการฯ
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
         </h4>
        </div>
        {!! Form::open(['url' => 'certify/check_certificate-ib/report/'.$report->id, 'class' => 'form-horizontal', 'files' => true,'id'=>"form_report"]) !!}
        <div class="modal-body">
           <div class="row">
             <div class="col-sm-12">
                <div class="form-group {{ $errors->has('report_date') ? 'has-error' : ''}}">
                    {!! HTML::decode(Form::label('report_date', '<span class="text-danger">*</span> วันที่ประชุม'.':', ['class' => 'col-md-4 control-label text-right'])) !!}
                    <div class="col-md-4 text-left">
                        <div class="input-group">
                            {!! Form::text('report_date', 
                             !empty($report->report_date)  ? HP::revertDate($report->report_date,true) :  null, 
                             ['class' => 'form-control mydatepicker check_readonly',
                             'required'=>true,
                   ...
                   <div class="col-md-7 text-left ">
                    ...
                    @if(isset($report) && !is_null($report->FileAttachReport1To))
                            <p class="text-left">
                                ...
                                @if ($report->CertiIBCostTo->require_scope_update != "1")
...
@include ('certify/ib/check_certificate_ib/modal.modal_review_edit_scope',['report' => $report ])
@push('js')
...
function submit_form_report() {
    ...
    $(document).ready(function () {
        ...
        $('#ask_to_edit_scope').click(function(event) {
            // alert('ok');
            $('#exampleModaEditIbScope').modal('show');
        });
