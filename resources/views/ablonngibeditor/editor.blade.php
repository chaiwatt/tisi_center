...
<head>
    ...
    <title>Document Editor | IB รายงานประเมินเอกสาร</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function downloadTemplate()
            {
                ...
                fetch("{{ route('ib.download-doc-review-html-template') }}", {
                    method: 'POST',
                    headers: {
            ...
            loadDefaultTemplateBtn.addEventListener('click', () => {
                ...
                fetch("{{ route('ib.default-download-doc-review-html-template') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            function saveData(status) {
                ...
                fetch("{{ route('ib.save-doc-review-html-template') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            exportButton_old.addEventListener('click', () => {
                loadingIndicator.style.display = 'inline-block';
