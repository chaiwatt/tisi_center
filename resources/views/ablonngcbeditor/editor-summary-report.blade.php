...
<head>
    ...
    <title>Editor - CB สรุปรายงานการตรวจ</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function downloadTemplate()
            {
                ...
                // alert('aha');
                fetch("{{ route('cb.download-summary-report-html-template') }}", {
                    method: 'POST',
                    headers: {
            ...
            loadDefaultTemplateBtn.addEventListener('click', () => {
                ...
                fetch("{{ route('cb.default-download-summary-report-html-template') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            function saveData(status) {
                ...
                fetch("{{ route('cb.save-summary-report-html-template') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
