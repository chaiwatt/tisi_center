...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">แต่งตั้งคณะผู้ตรวจประเมิน (LAB) ตรวจติดตาม</h3>
                    ...
                    {!! Form::open(['url' => '/certificate/auditor-labs', 'class' => 'form-horizontal', 'files' => true,'id'=>'form_auditor']) !!}
