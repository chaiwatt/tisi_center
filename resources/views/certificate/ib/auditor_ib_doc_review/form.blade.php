...
<div class="row">
     <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('ib_name') ? 'has-error' : '' }}">
            <label for="ib_name" class="col-md-5 control-label">ชื่อผู้ยื่นคำขอ :</label>
            <div class="col-md-7">
                <input type="text" id="ib_name" name="ib_name" class="form-control no-drop" value="{{ $tracking->certificate_export_to->applications->EsurvTrader->name ?? '' }}" readonly>
            </div>
        </div>
        
        <div class="form-group {{ $errors->has('name_unit') ? 'has-error' : '' }}">
            <label for="name_unit" class="col-md-5 control-label">ชื่อหน่วยรับรอง :</label>
            <div class="col-md-7">
                <input type="text" id="name_unit" name="name_unit" class="form-control" value="{{ $tracking->certificate_export_to->applications->name_unit ?? '' }}" disabled>
            </div>
        </div>
        ...
        <div class="form-group {{ $errors->has('auditor') ? 'has-error' : '' }}">
            ...
            <div class="col-md-7">
                <input type="text" id="auditor" name="auditor" class="form-control" maxlength="255" value="{{ 'คณะผู้ตรวจหน่วยรับรอง '.$tracking->certificate_export_to->applications->name_unit ?? '' }}" required>
            </div>
        </div>
            ...
            <div class="form-group dev_form_date {{ $errors->has('judgement_date') ? 'has-error' : ''}}">
                <label for="judgement_date" class="col-md-5 control-label">
