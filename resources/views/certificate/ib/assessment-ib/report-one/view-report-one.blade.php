    ...
    <div class="modal-dialog">
        ...
        <form id="labMessageForm" method="POST" action="{{ route('save.create_lab_message_record') }}">
            ...
            <div class="section">
                ...
                <div class="content">
                    {{-- <div class="info">
                        @foreach ($certi_ib->CertiIBAuditorsTo->CertiIBAuditorsLists  as $key => $auditor)
...
var ibReportOne = @json($ibReportOne);
...
// console.log('ibReportOne',ibReportOne.item_401_chk);
let data;
const signer = [
    {
        "id": "1",
...
$(document).ready(function() 
{
    ...
    let data = [
    {
        "eval_riteria_text": ibReportOne.eval_riteria_text,
        "background_history": ibReportOne.background_history,
        "insp_proc": ibReportOne.insp_proc,
        "evaluation_key_point": ibReportOne.evaluation_key_point,
        "observation": ibReportOne.observation,
        "evaluation_result": ibReportOne.evaluation_result,
        "auditor_suggestion": ibReportOne.auditor_suggestion,
        "evaluation_detail": {
            "item_401": {
                "chk": ibReportOne.item_401_chk === "1",     
                "eval_select": ibReportOne.item_401_eval_select,  
                "comment": ibReportOne.item_401_comment      
            },
            "item_402": {
                "chk": ibReportOne.item_402_chk === "1",      
                "eval_select": ibReportOne.item_402_eval_select,
                "comment": ibReportOne.item_402_comment         
            },
            "item_501": {
                "chk": ibReportOne.item_501_chk === "1",      
                "eval_select": ibReportOne.item_501_eval_select,
                "comment": ibReportOne.item_501_comment         
            },
            "item_601": {
                "chk": ibReportOne.item_601_chk === "1",      
                "eval_select": ibReportOne.item_601_eval_select,
                "comment": ibReportOne.item_601_comment         
            },
            "item_602": {
                "chk": ibReportOne.item_602_chk === "1",      
                "eval_select": ibReportOne.item_602_eval_select,
                "comment": ibReportOne.item_602_comment         
            },
            "item_603": {
                "chk": ibReportOne.item_603_chk === "1",      
                "eval_select": ibReportOne.item_603_eval_select,
                "comment": ibReportOne.item_603_comment         
            },
            "item_701": {
                "chk": ibReportOne.item_701_chk === "1",      
                "eval_select": ibReportOne.item_701_eval_select,
                "comment": ibReportOne.item_701_comment         
            },
            "item_702": {
                "chk": ibReportOne.item_702_chk === "1",      
                "eval_select": ibReportOne.item_702_eval_select,
                "comment": ibReportOne.item_702_comment         
            },
            "item_703": {
                "chk": ibReportOne.item_703_chk === "1",      
                "eval_select": ibReportOne.item_703_eval_select,
                "comment": ibReportOne.item_703_comment         
            },
            "item_704": {
                "chk": ibReportOne.item_704_chk === "1",      
                "eval_select": ibReportOne.item_704_eval_select,
                "comment": ibReportOne.item_704_comment         
            },
            "item_705": {
                "chk": ibReportOne.item_705_chk === "1",      
                "eval_select": ibReportOne.item_705_eval_select,
                "comment": ibReportOne.item_705_comment         
            },
            "item_706": {
                "chk": ibReportOne.item_706_chk === "1",      
                "eval_select": ibReportOne.item_706_eval_select,
                "comment": ibReportOne.item_706_comment         
            },
            "item_801": {
                "chk": ibReportOne.item_801_chk === "1",      
                "eval_select": ibReportOne.item_801_eval_select,
                "comment": ibReportOne.item_801_comment         
            },
            "item_802": {
                "chk": ibReportOne.item_802_chk === "1",      
                "eval_select": ibReportOne.item_802_eval_select,
                "comment": ibReportOne.item_802_comment         
            },
            "item_803": {
                "chk": ibReportOne.item_803_chk === "1",      
                "eval_select": ibReportOne.item_803_eval_select,
                "comment": ibReportOne.item_803_comment         
            },
            "item_804": {
                "chk": ibReportOne.item_804_chk === "1",      
                "eval_select": ibReportOne.item_804_eval_select,
                "comment": ibReportOne.item_804_comment         
            },
            "item_805": {
                "chk": ibReportOne.item_805_chk === "1",      
                "eval_select": ibReportOne.item_805_eval_select,
                "comment": ibReportOne.item_805_comment         
            },
            "item_806": {
                "chk": ibReportOne.item_806_chk === "1",      
                "eval_select": ibReportOne.item_806_eval_select,
                "comment": ibReportOne.item_806_comment         
            },
            "item_807": {
                "chk": ibReportOne.item_807_chk === "1",      
                "eval_select": ibReportOne.item_807_eval_select,
                "comment": ibReportOne.item_807_comment         
            },
            "item_808": {
                "chk": ibReportOne.item_808_chk === "1",      
                "eval_select": ibReportOne.item_808_eval_select,
                "comment": ibReportOne.item_808_comment         
            },
            "insp_cert": {
                "chk": ibReportOne.insp_cert_chk === "1",      
                "eval_select": ibReportOne.insp_cert_eval_select,
                "comment": ibReportOne.insp_cert_comment         
            },
            "reg_std_mark": {
                "chk": ibReportOne.reg_std_mark_chk === "1",      
                "eval_select": ibReportOne.reg_std_mark_eval_select,
                "comment": ibReportOne.reg_std_mark_comment         
            }
        }
    }
];
...
if (ibReportOne.persons) {
    try {
        persons = JSON.parse(ibReportOne.persons);
        renderPersons();
    } catch (error) {
...
if (ibReportOne.attachments && Array.isArray(ibReportOne.attachments) && ibReportOne.attachments.length > 0) {
    references = ibReportOne.attachments.map(attachment => ({
...
function submit_form(status) 
{
    ...
    $.ajax({
        type: "POST",
        // url: "{{url('/certify/save_assessment-ib/ib-report-store')}}",
        url: "{{ route('certificate.assessment-ib.update_ib_report_one') }}",
        datatype: "script",
        data: formData,
        contentType: false,
        cache: false,
