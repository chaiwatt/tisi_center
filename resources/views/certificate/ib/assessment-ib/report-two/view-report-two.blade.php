...
var ibReportTwo = @json($ibReportTwo);
...
// console.log('ibReportTwo',ibReportTwo.item_401_chk);
let data;
const signer = [
    {
        "id": "1",
...
$(document).ready(function() 
{
    ...
    let data = [
    {
        "eval_riteria_text": ibReportTwo.eval_riteria_text,
        "background_history": ibReportTwo.background_history,
        "insp_proc": ibReportTwo.insp_proc,
        "evaluation_key_point": ibReportTwo.evaluation_key_point,
        "observation": ibReportTwo.observation,
        "evaluation_result": ibReportTwo.evaluation_result,
        "auditor_suggestion": ibReportTwo.auditor_suggestion,
        "evaluation_detail": {
            "item_401": {
                "chk": ibReportTwo.item_401_chk === "1",     
                "eval_select": ibReportTwo.item_401_eval_select,  
                "comment": ibReportTwo.item_401_comment      
            },
            "item_402": {
                "chk": ibReportTwo.item_402_chk === "1",      
                "eval_select": ibReportTwo.item_402_eval_select,
                "comment": ibReportTwo.item_402_comment         
            },
            "item_501": {
                "chk": ibReportTwo.item_501_chk === "1",      
                "eval_select": ibReportTwo.item_501_eval_select,
                "comment": ibReportTwo.item_501_comment         
            },
            "item_601": {
                "chk": ibReportTwo.item_601_chk === "1",      
                "eval_select": ibReportTwo.item_601_eval_select,
                "comment": ibReportTwo.item_601_comment         
            },
            "item_602": {
                "chk": ibReportTwo.item_602_chk === "1",      
                "eval_select": ibReportTwo.item_602_eval_select,
                "comment": ibReportTwo.item_602_comment         
            },
            "item_603": {
                "chk": ibReportTwo.item_603_chk === "1",      
                "eval_select": ibReportTwo.item_603_eval_select,
                "comment": ibReportTwo.item_603_comment         
            },
            "item_701": {
                "chk": ibReportTwo.item_701_chk === "1",      
                "eval_select": ibReportTwo.item_701_eval_select,
                "comment": ibReportTwo.item_701_comment         
            },
            "item_702": {
                "chk": ibReportTwo.item_702_chk === "1",      
                "eval_select": ibReportTwo.item_702_eval_select,
                "comment": ibReportTwo.item_702_comment         
            },
            "item_703": {
                "chk": ibReportTwo.item_703_chk === "1",      
                "eval_select": ibReportTwo.item_703_eval_select,
                "comment": ibReportTwo.item_703_comment         
            },
            "item_704": {
                "chk": ibReportTwo.item_704_chk === "1",      
                "eval_select": ibReportTwo.item_704_eval_select,
                "comment": ibReportTwo.item_704_comment         
            },
            "item_705": {
                "chk": ibReportTwo.item_705_chk === "1",      
                "eval_select": ibReportTwo.item_705_eval_select,
                "comment": ibReportTwo.item_705_comment         
            },
            "item_706": {
                "chk": ibReportTwo.item_706_chk === "1",      
                "eval_select": ibReportTwo.item_706_eval_select,
                "comment": ibReportTwo.item_706_comment         
            },
            "item_801": {
                "chk": ibReportTwo.item_801_chk === "1",      
                "eval_select": ibReportTwo.item_801_eval_select,
                "comment": ibReportTwo.item_801_comment         
            },
            "item_802": {
                "chk": ibReportTwo.item_802_chk === "1",      
                "eval_select": ibReportTwo.item_802_eval_select,
                "comment": ibReportTwo.item_802_comment         
            },
            "item_803": {
                "chk": ibReportTwo.item_803_chk === "1",      
                "eval_select": ibReportTwo.item_803_eval_select,
                "comment": ibReportTwo.item_803_comment         
            },
            "item_804": {
                "chk": ibReportTwo.item_804_chk === "1",      
                "eval_select": ibReportTwo.item_804_eval_select,
                "comment": ibReportTwo.item_804_comment         
            },
            "item_805": {
                "chk": ibReportTwo.item_805_chk === "1",      
                "eval_select": ibReportTwo.item_805_eval_select,
                "comment": ibReportTwo.item_805_comment         
            },
            "item_806": {
                "chk": ibReportTwo.item_806_chk === "1",      
                "eval_select": ibReportTwo.item_806_eval_select,
                "comment": ibReportTwo.item_806_comment         
            },
            "item_807": {
                "chk": ibReportTwo.item_807_chk === "1",      
                "eval_select": ibReportTwo.item_807_eval_select,
                "comment": ibReportTwo.item_807_comment         
            },
            "item_808": {
                "chk": ibReportTwo.item_808_chk === "1",      
                "eval_select": ibReportTwo.item_808_eval_select,
                "comment": ibReportTwo.item_808_comment         
            },
            "insp_cert": {
                "chk": ibReportTwo.insp_cert_chk === "1",      
                "eval_select": ibReportTwo.insp_cert_eval_select,
                "comment": ibReportTwo.insp_cert_comment         
            },
            "reg_std_mark": {
                "chk": ibReportTwo.reg_std_mark_chk === "1",      
                "eval_select": ibReportTwo.reg_std_mark_eval_select,
                "comment": ibReportTwo.reg_std_mark_comment         
            }
        }
    }
];
...
if (ibReportTwo.persons) {
    try {
        persons = JSON.parse(ibReportTwo.persons);
        renderPersons();
    } catch (error) {
...
if (ibReportTwo.attachments && Array.isArray(ibReportTwo.attachments) && ibReportTwo.attachments.length > 0) {
    references = ibReportTwo.attachments.map(attachment => ({
...
function submit_form(status) 
{
    ...
    $.ajax({
        ...
        url: "{{ route('certificate.assessment-ib.update_ib_report_two') }}",
        datatype: "script",
        data: formData,
        contentType: false,
        cache: false,
