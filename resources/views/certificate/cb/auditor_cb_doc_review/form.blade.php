...
<div class="row">
     <div class="col-md-12">
        ...
        <div class="form-group {{ $errors->has('cb_name') ? 'has-error' : '' }}">
            <label for="cb_name" class="col-md-5 control-label">ชื่อผู้ยื่นคำขอ :</label>
            <div class="col-md-7">
                <input type="text" id="cb_name" name="cb_name" class="form-control no-drop" value="{{ $tracking->certificate_export_to->CertiCbTo->EsurvTrader->name ?? '' }}" readonly>
            </div>
        </div>
        
        <div class="form-group {{ $errors->has('name_standard') ? 'has-error' : '' }}">
            <label for="name_standard" class="col-md-5 control-label">ชื่อหน่วยรับรอง :</label>
            <div class="col-md-7">
                <input type="text" id="name_standard" name="name_standard" class="form-control" value="{{ $tracking->certificate_export_to->CertiCbTo->name_standard ?? '' }}" disabled>
            </div>
        </div>
        ...
        <div class="form-group {{ $errors->has('auditor') ? 'has-error' : '' }}">
            ...
            <div class="col-md-7">
                <input type="text" id="auditor" name="auditor" class="form-control" maxlength="255" value="{{ 'คณะผู้ตรวจหน่วยรับรอง '.$tracking->certificate_export_to->CertiCbTo->name_standard ?? '' }}" required>
            </div>
        </div>
