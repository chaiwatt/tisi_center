...
<body>
    <div class="wrapper">
        ...
        <form id="cbMessageForm" method="POST" action="{{ route('certificate.auditor-cbs.save-tracking-cb-message-record') }}">
            @csrf
            <!-- ส่วนราชการ -->
            ...
            <table class="table-section">
                <tr>
                    ...
                    <td style="width: 300px;">
                        <input type="text" class="input-no-border" id="header_text1" value="{{$boardAuditorMsRecordInfo->header_text1}}" value="สก รป." readonly>
                    </td>
                    <td style="font-size:22px">โทรศัพท์</td>
                    <td style="width: 235px">
                        <input type="text" class="input-no-border" id="header_text2" value="{{$boardAuditorMsRecordInfo->header_text2}}" value="{{ old('header_text2') }}" readonly>
                    </td>
                </tr>
            </table>
            ...
            <!-- Main Content -->
            <div class="section">
                <div>เรียน ผอ.สก. ผ่าน ผก.รต.<input type="text" class="input-no-border" id="body_text1" value="{{$boardAuditorMsRecordInfo->body_text1}}" value="body_text1" style="width:30px" readonly></div>
