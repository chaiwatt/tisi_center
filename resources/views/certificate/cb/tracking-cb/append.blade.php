...
@section('content')
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    @can('view-'.str_slug('certificateexportcb'))
                        <a class="btn btn-success pull-right" href="{{url('/certificate/tracking-cb/'.$tracking->id.'/edit')}}">
    ...
    <div class="row">
                   ...
                   <div class="table-responsive">
                          ...
                          <table class="table color-bordered-table info-bordered-table"  id="myTable">
                              ...
                              <tbody>
                                ...
                                @endphp
                                @if ($certicb_file_all and $certicb_file_all->count() > 0)
                                @foreach ($certicb_file_all as $item)
                                    <tr>
      ...
      {!! Form::open(['url' => 'certificate/tracking-cb/update_append/'.$tracking->id,
