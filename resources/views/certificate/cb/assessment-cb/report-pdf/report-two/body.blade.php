    ...
    <div class="topic_four">
        ...
        <div class="topic_four">
            ...
            <table style="margin-left: 20px; line-height: 1.2;">
                ...
                @if (!is_null($cbReportTwo->persons))
                @foreach (json_decode($cbReportTwo->persons, true) as $person)
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_401_chk" {{ $cbReportTwo->item_401_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">                               
                            @if ($cbReportTwo->item_401_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_401_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">
                            {{$cbReportTwo->item_401_comment}}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_402_chk" {{ $cbReportTwo->item_402_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_402_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_402_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">
                            {{$cbReportTwo->item_402_comment}}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_501_chk" {{ $cbReportTwo->item_501_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_501_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_501_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_501_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 6.1 บุคลากร</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_601_chk" {{ $cbReportTwo->item_601_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_601_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_601_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_601_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 6.2 สิ่งอำนวยความสะดวกและเครื่องมือ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_602_chk" {{ $cbReportTwo->item_602_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_602_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_602_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_602_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 6.3 การจ้างเหมาช่วง</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_603_chk" {{ $cbReportTwo->item_603_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_603_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_603_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_603_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.1 ขั้นตอนการดำเนินงาน และวิธีการตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_701_chk" {{ $cbReportTwo->item_701_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_701_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_701_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_701_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.2 การจัดการตัวอย่างและรายงานที่ตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_702_chk" {{ $cbReportTwo->item_702_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_702_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_702_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_702_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.3 บันทึกผลการตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_703_chk" {{ $cbReportTwo->item_703_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_703_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_703_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_703_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.4 ใบรายงานผลการตรวจและใบรับรองการตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_704_chk" {{ $cbReportTwo->item_704_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_704_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_704_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_704_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.5 การร้องเรียนและการอุทธรณ์</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_705_chk" {{ $cbReportTwo->item_705_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_705_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_705_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_705_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.6 กระบวนการร้องเรียนและการอุทธรณ์</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_706_chk" {{ $cbReportTwo->item_706_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_706_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_706_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_706_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.1 ทางเลือก</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_801_chk" {{ $cbReportTwo->item_801_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_801_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_801_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_801_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.2 เอกสารระบบการบริหารงาน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_802_chk" {{ $cbReportTwo->item_802_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_802_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_802_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_802_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.3 การควบคุมเอกสาร (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_803_chk" {{ $cbReportTwo->item_803_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_803_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_803_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_803_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.4 การควบคุมบันทึก (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_804_chk" {{ $cbReportTwo->item_804_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_804_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_804_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_804_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.5 การทบทวนระบบการบริหารงาน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_805_chk" {{ $cbReportTwo->item_805_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_805_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_805_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_805_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.6 การประเมินภายใน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_806_chk" {{ $cbReportTwo->item_806_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_806_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_806_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_806_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.7 การฟฎิบัติการแก้ไข (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_807_chk" {{ $cbReportTwo->item_807_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_807_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_807_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_807_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.8 การฟฎิบัติการป้องกัน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_808_chk" {{ $cbReportTwo->item_808_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->item_808_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->item_808_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->item_808_comment}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 500;padding-left: 10px">หลักเกณฑ์ วิธีการ และเงื่อนไขการรับรองหน่วยตรวจ พ.ศ.2564 </td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="insp_cert_chk" {{ $cbReportTwo->insp_cert_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->insp_cert_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->insp_cert_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->insp_cert_comment}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 500;padding-left: 10px">กฏกระทรวง กำหนดลักษณะ การทำ การใช้ และการแสดงเครื่องหมายมาตรฐาน </td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="reg_std_mark_chk" {{ $cbReportTwo->reg_std_mark_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportTwo->reg_std_mark_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportTwo->reg_std_mark_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportTwo->reg_std_mark_comment}}</td>
                    </tr>
