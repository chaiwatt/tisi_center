    ...
    <div class="topic_four">
        ...
        <div class="topic_four">
            ...
            <table style="margin-left: 20px; line-height: 1.2;">
                ...
                @if (!is_null($cbReportOne->persons))
                @foreach (json_decode($cbReportOne->persons, true) as $person)
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_401_chk" {{ $cbReportOne->item_401_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">                               
                            @if ($cbReportOne->item_401_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_401_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">
                            {{$cbReportOne->item_401_comment}}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_402_chk" {{ $cbReportOne->item_402_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_402_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_402_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">
                            {{$cbReportOne->item_402_comment}}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_501_chk" {{ $cbReportOne->item_501_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_501_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_501_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_501_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 6.1 บุคลากร</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_601_chk" {{ $cbReportOne->item_601_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_601_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_601_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_601_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 6.2 สิ่งอำนวยความสะดวกและเครื่องมือ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_602_chk" {{ $cbReportOne->item_602_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_602_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_602_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif    
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_602_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 6.3 การจ้างเหมาช่วง</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_603_chk" {{ $cbReportOne->item_603_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_603_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_603_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_603_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.1 ขั้นตอนการดำเนินงาน และวิธีการตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_701_chk" {{ $cbReportOne->item_701_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_701_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_701_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_701_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.2 การจัดการตัวอย่างและรายงานที่ตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_702_chk" {{ $cbReportOne->item_702_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_702_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_702_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_702_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.3 บันทึกผลการตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_703_chk" {{ $cbReportOne->item_703_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_703_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_703_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_703_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.4 ใบรายงานผลการตรวจและใบรับรองการตรวจ</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_704_chk" {{ $cbReportOne->item_704_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_704_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_704_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_704_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.5 การร้องเรียนและการอุทธรณ์</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_705_chk" {{ $cbReportOne->item_705_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_705_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_705_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_705_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 7.6 กระบวนการร้องเรียนและการอุทธรณ์</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_706_chk" {{ $cbReportOne->item_706_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_706_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_706_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_706_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.1 ทางเลือก</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_801_chk" {{ $cbReportOne->item_801_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_801_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_801_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_801_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.2 เอกสารระบบการบริหารงาน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_802_chk" {{ $cbReportOne->item_802_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_802_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_802_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_802_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.3 การควบคุมเอกสาร (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_803_chk" {{ $cbReportOne->item_803_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_803_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_803_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_803_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.4 การควบคุมบันทึก (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_804_chk" {{ $cbReportOne->item_804_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_804_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_804_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_804_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.5 การทบทวนระบบการบริหารงาน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_805_chk" {{ $cbReportOne->item_805_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_805_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_805_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_805_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.6 การประเมินภายใน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_806_chk" {{ $cbReportOne->item_806_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_806_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_806_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_806_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.7 การฟฎิบัติการแก้ไข (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_807_chk" {{ $cbReportOne->item_807_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_807_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_807_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_807_comment}}</td>
                    </tr>
                    <tr>
                        <td style="padding-left: 10px">ข้อ 8.8 การฟฎิบัติการป้องกัน (ทางเลือก A)</td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="item_808_chk" {{ $cbReportOne->item_808_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->item_808_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->item_808_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->item_808_comment}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 500;padding-left: 10px">หลักเกณฑ์ วิธีการ และเงื่อนไขการรับรองหน่วยตรวจ พ.ศ.2564 </td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="insp_cert_chk" {{ $cbReportOne->insp_cert_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->insp_cert_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->insp_cert_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->insp_cert_comment}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 500;padding-left: 10px">กฏกระทรวง กำหนดลักษณะ การทำ การใช้ และการแสดงเครื่องหมายมาตรฐาน </td>
                        <td style="text-align: center">
                            <div class="evaluation-checkbox-item">
                                <input type="checkbox" id="reg_std_mark_chk" {{ $cbReportOne->reg_std_mark_chk == 1 ? 'checked="checked"' : '' }}>
                            </div>
                        </td>
                        <td style="text-align: center">
                            @if ($cbReportOne->reg_std_mark_eval_select == 1)
                                สอดคล้อง
                            @elseif($cbReportOne->reg_std_mark_eval_select == 2)
                                ไม่สอดคล้อง
                            @endif
                        </td>
                        <td style="padding-left: 5px;text-align:center;font-size:22px">{{$cbReportOne->reg_std_mark_comment}}</td>
                    </tr>
