...
// var cbReportTwo = @json($cbReportTwo);
...
// console.log('cbReportTwo',cbReportTwo.item_401_chk);
let data;
const signer = [
    {
        "id": "1",
...
$(document).ready(function() 
{
    ...
    let data = [
    {
        "eval_riteria_text": cbReportTwo.eval_riteria_text,
        "background_history": cbReportTwo.background_history,
        "insp_proc": cbReportTwo.insp_proc,
        "evaluation_key_point": cbReportTwo.evaluation_key_point,
        "observation": cbReportTwo.observation,
        "evaluation_result": cbReportTwo.evaluation_result,
        "auditor_suggestion": cbReportTwo.auditor_suggestion,
        "evaluation_detail": {
            "item_401": {
                "chk": cbReportTwo.item_401_chk === "1",     
                "eval_select": cbReportTwo.item_401_eval_select,  
                "comment": cbReportTwo.item_401_comment      
            },
            "item_402": {
                "chk": cbReportTwo.item_402_chk === "1",      
                "eval_select": cbReportTwo.item_402_eval_select,
                "comment": cbReportTwo.item_402_comment         
            },
            "item_501": {
                "chk": cbReportTwo.item_501_chk === "1",      
                "eval_select": cbReportTwo.item_501_eval_select,
                "comment": cbReportTwo.item_501_comment         
            },
            "item_601": {
                "chk": cbReportTwo.item_601_chk === "1",      
                "eval_select": cbReportTwo.item_601_eval_select,
                "comment": cbReportTwo.item_601_comment         
            },
            "item_602": {
                "chk": cbReportTwo.item_602_chk === "1",      
                "eval_select": cbReportTwo.item_602_eval_select,
                "comment": cbReportTwo.item_602_comment         
            },
            "item_603": {
                "chk": cbReportTwo.item_603_chk === "1",      
                "eval_select": cbReportTwo.item_603_eval_select,
                "comment": cbReportTwo.item_603_comment         
            },
            "item_701": {
                "chk": cbReportTwo.item_701_chk === "1",      
                "eval_select": cbReportTwo.item_701_eval_select,
                "comment": cbReportTwo.item_701_comment         
            },
            "item_702": {
                "chk": cbReportTwo.item_702_chk === "1",      
                "eval_select": cbReportTwo.item_702_eval_select,
                "comment": cbReportTwo.item_702_comment         
            },
            "item_703": {
                "chk": cbReportTwo.item_703_chk === "1",      
                "eval_select": cbReportTwo.item_703_eval_select,
                "comment": cbReportTwo.item_703_comment         
            },
            "item_704": {
                "chk": cbReportTwo.item_704_chk === "1",      
                "eval_select": cbReportTwo.item_704_eval_select,
                "comment": cbReportTwo.item_704_comment         
            },
            "item_705": {
                "chk": cbReportTwo.item_705_chk === "1",      
                "eval_select": cbReportTwo.item_705_eval_select,
                "comment": cbReportTwo.item_705_comment         
            },
            "item_706": {
                "chk": cbReportTwo.item_706_chk === "1",      
                "eval_select": cbReportTwo.item_706_eval_select,
                "comment": cbReportTwo.item_706_comment         
            },
            "item_801": {
                "chk": cbReportTwo.item_801_chk === "1",      
                "eval_select": cbReportTwo.item_801_eval_select,
                "comment": cbReportTwo.item_801_comment         
            },
            "item_802": {
                "chk": cbReportTwo.item_802_chk === "1",      
                "eval_select": cbReportTwo.item_802_eval_select,
                "comment": cbReportTwo.item_802_comment         
            },
            "item_803": {
                "chk": cbReportTwo.item_803_chk === "1",      
                "eval_select": cbReportTwo.item_803_eval_select,
                "comment": cbReportTwo.item_803_comment         
            },
            "item_804": {
                "chk": cbReportTwo.item_804_chk === "1",      
                "eval_select": cbReportTwo.item_804_eval_select,
                "comment": cbReportTwo.item_804_comment         
            },
            "item_805": {
                "chk": cbReportTwo.item_805_chk === "1",      
                "eval_select": cbReportTwo.item_805_eval_select,
                "comment": cbReportTwo.item_805_comment         
            },
            "item_806": {
                "chk": cbReportTwo.item_806_chk === "1",      
                "eval_select": cbReportTwo.item_806_eval_select,
                "comment": cbReportTwo.item_806_comment         
            },
            "item_807": {
                "chk": cbReportTwo.item_807_chk === "1",      
                "eval_select": cbReportTwo.item_807_eval_select,
                "comment": cbReportTwo.item_807_comment         
            },
            "item_808": {
                "chk": cbReportTwo.item_808_chk === "1",      
                "eval_select": cbReportTwo.item_808_eval_select,
                "comment": cbReportTwo.item_808_comment         
            },
            "insp_cert": {
                "chk": cbReportTwo.insp_cert_chk === "1",      
                "eval_select": cbReportTwo.insp_cert_eval_select,
                "comment": cbReportTwo.insp_cert_comment         
            },
            "reg_std_mark": {
                "chk": cbReportTwo.reg_std_mark_chk === "1",      
                "eval_select": cbReportTwo.reg_std_mark_eval_select,
                "comment": cbReportTwo.reg_std_mark_comment         
            }
        }
    }
];
...
console.log('cbReportTwo',cbReportTwo)
if (cbReportTwo.persons) {
    try {
        persons = JSON.parse(cbReportTwo.persons);
        renderPersons();
    } catch (error) {
...
if (cbReportTwo.attachments && Array.isArray(cbReportTwo.attachments) && cbReportTwo.attachments.length > 0) {
    references = cbReportTwo.attachments.map(attachment => ({
...
function submit_form(status) 
{
    ...
    $.ajax({
        ...
        url: "{{ route('certificate.assessment-cb.update_cb_report_two') }}",
        datatype: "script",
        data: formData,
        contentType: false,
        cache: false,
