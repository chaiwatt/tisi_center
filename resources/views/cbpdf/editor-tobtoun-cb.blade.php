...
<head>
    ...
    <title>Document Editor | CB แต่งตั้งคณะทบทวน</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function downloadTemplate()
            {
                ...
                fetch("{{ route('cb.download-tangtung-tobtoun-template') }}", {
                    method: 'POST',
                    headers: {
            ...
            loadDefaultTemplateBtn.addEventListener('click', () => {
                ...
                fetch("{{ route('cb.default-download-tangtung-tobtoun-template') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            function saveData(status) {
                ...
                fetch("{{ route('cb.save-tangtung-tobtoun-template') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
