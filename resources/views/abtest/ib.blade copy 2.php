...
/* --- Table Styling (Adjusted for no borders and normal spacing) --- */
table {
    width: 100%;
    border-collapse: collapse;
    margin: 0; /* Ensure no default table margin */
    table-layout: fixed;
    border: none !important; /* No border for tables, ensure override */
}

table.borderless { /* Keep this if used for other tables, but ensure it has no borders */
    border: none !important;
}

th, td {
    border: none !important; /* No border for cells, ensure override */
    padding: 0; /* Set padding to 0 by default for tight spacing */
    vertical-align: top;
    word-wrap: break-word;
    line-height: 1.1; /* Consistent line height for text within cells, matching body/page */
}

/* Specific styles for the new table-based layout */
.report-main-table {
    /* Inherits border: none from global table rule */
    font-family: 'thsarabunnew', 'Arial', sans-serif;
    font-size: 20px;
}
...
.section-table {
    margin-top: 7px; /* Further reduced margin between sections */
    margin-bottom: 4px; /* Further reduced margin between sections */
}
...
.label-cell {
    ...
    /* Inherits line-height from global td rule */
}
...
.phone-fax-table td {
    ...
    /* Inherits vertical-align and word-wrap from global td rule */
}
...
.checkbox-item-cell {
    ...
    text-align: left;
    /* Inherits vertical-align from global td rule */
}
            ...
            const templateHTML = `
                ...
                <table class="section-table" style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td class="content-cell">
                            <table class="phone-fax-table" style="width: 100%; border-collapse: collapse;">
                                <tr>
                ...
                <table class="section-table" style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td class="content-cell">
                            <table class="checkbox-table" style="width: 100%; border-collapse: collapse;">
                                <tr>
                ...
                <!-- Section 10: รายละเอียดการตรวจประเมิน -->
                <table class="section-table" style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td class="label-cell" style="width: 150px;">10. รายละเอียดการตรวจประเมิน : </td>
                    </tr>
                     <tr>
                        <td class="label-cell" style="width: 150px;padding-left:30px" >10.1 ความเป็นมา : </td>
                    </tr>
                    <tr>
                        <td class="content-cell" style="width: 150px;padding-left:60px" >
                            บริษัท ทีไอเอส อินสเปคชั่น จำกัด ซึ่งต่อไปนี้จะเรียกว่า หน่วยตรวจ ได้รับการรับรองระบบงานหน่วยตรวจครั้งแรก เมื่อวันที่ 19 พฤษภาคม 2563 ต่อมาได้ต่ออายุการรับรอง และได้รับการรับรองระบบงานการตรวจประเภท A ตามใบรับรองเลขที่ 24-IB0002 ตั้งแต่วันที่ 12 ธันวาคม 2566 ถึงวันที่ 18 พฤษภาคม 2571 ในสาขาและขอบข่ายตามที่ระบุในภาคผนวก ก. ซึ่งปัจจุบันอยู่ในระหว่างการติดตามผลการรับรองระบบงานครั้งที่ 1
                        </td>
                    </tr>
                </table>
                `;
