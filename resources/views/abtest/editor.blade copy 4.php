...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const managePages = () => {
                ...
                if (pages.length > 1) {
                    for (let i = pages.length - 1; i > 0; i--) {
                        ...
                        const hasOnlyEmptyP = page.innerHTML === '<p><br></p>';
            ...
            // --- *** START: SIMPLIFIED AND STABLE KEYDOWN LOGIC *** ---
            editor.addEventListener('keydown', (e) => {
                ...
                // For any Backspace or Delete, just run the standard page management.
                // This will handle cleaning up empty pages that result from deletion.
                if (e.key === 'Delete' || e.key === 'Backspace') {
                    setTimeout(managePages, 10);
                }
            });
            // --- *** END: SIMPLIFIED AND STABLE KEYDOWN LOGIC *** ---
