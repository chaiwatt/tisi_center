...
th, td {
    ...
    padding: 5px 8px;      /* เพิ่ม padding ทำให้ภายในเซลล์โปร่งขึ้น */
    vertical-align: top;
    word-wrap: break-word;
    line-height: 1.3;      /* เพิ่มความสูงของบรรทัดให้อ่านง่ายขึ้น */
}
       ...
       const insertIbReportOneTemplate = () => {
            ...
            const templateHTML = `
                ...
                <table class="borderless section-table" style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td class="content-cell">
                            หน่วยรับรองได้รับการรับรองระบบงาน สาขา...
                        </td>
                    </tr>
                </table>
                ...
                <table class="borderless section-table" style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td  style="width: 150px;"><b>6. วันที่ตรวจประเมิน :</b> 24-25 มีนาคม 2568 </td>
                    </tr>
                </table>
                ...
                <table class="borderless section-table" style="width: 100%; border-collapse: collapse">
                    <tr>
                        <td  style="width: 150px;"><b>9. ผู้แทนหน่วยตรวจ</b> : รายละเอียดดัง เอกสารแบบ 2 </td>
                    </tr>
                </table>
                ...
                <!-- Section 10.4: Assessment Details Table (Corrected) -->
                <div>
                    &nbsp;&nbsp;<b> 10.4 รายละเอียดผลการตรวจประเมิน</b><br>
                <table class="w-full border-collapse bordered-table mt-2 text-sm">
                    <thead>
                        <tr>
                            <th style="width: 180px;">เกณฑ์ที่ใช้ในการตรวจประเมิน</th>
                            <th style="width: 30px;text-align:center">รายการที่ตรวจ</th>
                            <th style="width: 50px;">ผลการตรวจประเมิน</th>
                            <th style="width: 120px;">หมายเหตุ</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="4" class="font-bold bg-gray-50">มอก. 17020-2556 และ ILAC-P15: 05/2020</td>
                        </tr>
                        <tr>
                            <td>ข้อ 4.1 ความเป็นกลางและความเป็นอิสระ</td>
                            <td class="checkbox-cell cell-center" style="width: 30px;text-align:center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>ข้อ 4.2 การรักษาความลับ</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>ข้อ 5.1 คุณลักษณะที่ต้องการด้านการบริหาร</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>ข้อ 5.2 องค์กรและการบริหาร</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td>ข้อ 7.2 การจัดการตัวอย่างและรายการที่ตรวจ</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td>ข้อ 8.2 เอกสารระบบบริหารงาน (ทางเลือก A)</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>ข้อ 8.5 การทบทวนระบบบริหารงาน (ทางเลือก A)</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td>ข้อ 8.7 การปฏิบัติการแก้ไข (ทางเลือก A)</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>ข้อ 8.8 การปฏิบัติการป้องกัน (ทางเลือก A)</td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="font-bold bg-gray-50"><b>หลักเกณฑ์ วิธีการและเงื่อนไขการรับรองหน่วยตรวจ พ.ศ. 2564<b></td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="font-bold bg-gray-50"><b>กฎกระทรวง กำหนดลักษณะ การทำ การใช้ และการแสดงเครื่องหมายมาตรฐาน<b></td>
                            <td class="checkbox-cell cell-center"><input type="checkbox"></td>
                            <td class="cell-center">สอดคล้อง</td>
                            <td></td>
                        </tr>
                ...
                <br>
                &nbsp;&nbsp;<b> 10.5 ข้อสังเกตุ</b><br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1) ควรพิจารณา ....<br>
                <b>11. ผลการตรวจประเมิน</b><br>
                    &nbsp;&nbsp;...<br>
                <b>12. ความเห็น/ข้อเสนอแนะของคณะผู้ตรวจประเมิน</b><br>
                    &nbsp;&nbsp;...<br>
                `;
        ...
        function insertTableRow(table, rowIndex, above, removeConnectingBorder) {
            ...
            } else if (rowIndex >= 0 && table.rows[rowIndex]) {
                colCount = table.rows[rowIndex].cells.length;
            } else if (table.rows.length > 1) { // rowIndex could be invalid for new tables
            ...
            if (removeConnectingBorder) {
                if (!above) { // Inserting BELOW
                    ...
                    const rowBelow = table.rows[insertAt + 1];
                    for (const cell of newRow.cells) {
                        cell.style.borderBottom = 'none';
                    }
                    if (rowBelow) {
            ...
            // Run layout management first
            managePages();

            // *** NEW LOGIC: Place cursor in the new row AFTER managing pages ***
            const firstCell = newRow.cells[0];
            if (firstCell) {
                firstCell.focus(); // Ensure the contenteditable area has focus
                const range = document.createRange();
                const selection = window.getSelection();
                range.setStart(firstCell, 0); // Place cursor at the beginning of the cell
                range.collapse(true);
                selection.removeAllRanges(); // Clear any previous selection
                selection.addRange(range);   // Apply the new cursor position
            }
        }
        // === END: MODIFICATION ===
